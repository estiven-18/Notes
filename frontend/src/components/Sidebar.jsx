...
const Sidebar = ({ activeNote, onSelectNote, onAddCollection, favoriteRefreshKey, sharedRefreshKey, collectionRefreshKey, onShowTrash, showTrash, trashRefreshKey, onToggleSidebar, onNoteChange, activeCollection, isOpen }) => {
  ...
  return (
    <aside className={`sidebar${isOpen ? ' sidebar-open' : ''}`}>
      ...
      <div className="sidebar-nav-icons">
        ...
        <button className={`sidebar-nav-icon-btn sidebar-nav-icon-customize ${showSidebarCustomize ? 'active' : ''}`} title="Personalizar secciones" onClick={() => setShowSidebarCustomize(!showSidebarCustomize)}>
